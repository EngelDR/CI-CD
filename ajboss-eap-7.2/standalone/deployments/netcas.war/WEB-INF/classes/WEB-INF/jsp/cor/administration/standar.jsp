...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		<h3 class=n-titles><spring:message code="language.tags.0038.02.01"/></h3>
		...
		<div class="modal-footer">
			<button id="btnNewCommand" class="btn btn-primary">
				<span class="glyphicon glyphicon-plus"></span> <spring:message code="language.tags.0038.02.02"/>		<!-- Nuevo Comando -->
			</button>
		</div>
